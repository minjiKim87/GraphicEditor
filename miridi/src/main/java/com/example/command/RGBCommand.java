...
public class RGBCommand extends PropertyCommand {
    private final PropertyController propertyController;
    private MultiSelectController multiSelectController;
    @FXML
    private AnchorPane centerAnchorPane;

    public RGBCommand(PropertyController propertyController, MultiSelectController multiSelectController) {
    ...
    public void handleRGBTextFields(MultiSelectController multiSelectController){
        super.propertyController.handleRGBTextFields(multiSelectController);
    }
    ...
    public void execute(MultiSelectController multiSelectController) {
        ...
        propertyController.handleRGBTextFields(multiSelectController);
    }
