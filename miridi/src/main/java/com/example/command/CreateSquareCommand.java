...
public class CreateSquareCommand extends DrawingCommand {
    private final ShapeCreatorController shapeCreatorController;

    public CreateSquareCommand(ShapeCreatorController shapeCreatorController, ShapeController shapeController) {
