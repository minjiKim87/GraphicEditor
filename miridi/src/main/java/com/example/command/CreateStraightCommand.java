...
public class CreateStraightCommand extends DrawingCommand {
    private final ShapeCreatorController shapeCreatorController;

    public CreateStraightCommand(ShapeCreatorController shapeCreatorController, ShapeController shapeController) {
