...
public class CreateCurveCommand extends DrawingCommand {
    private final ShapeCreatorController shapeCreatorController;

    public CreateCurveCommand(ShapeCreatorController shapeCreatorController, ShapeController shapeController) {
