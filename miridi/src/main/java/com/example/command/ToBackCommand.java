...
public class ToBackCommand extends PropertyCommand {
    private PropertyController propertyController;
    private MultiSelectController multiSelectController;
    @FXML
    private AnchorPane centerAnchorPane;

    public ToBackCommand(PropertyController propertyController, MultiSelectController multiSelectController) {
    ...
    public void execute(List<Shape> selectedShapes) {
        System.out.println("ToBackCommand IN");
        propertyController.ToBackObject(selectedShapes);
        System.out.println("ToBackObject execute");
    }
